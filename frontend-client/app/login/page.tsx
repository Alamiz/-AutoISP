                ...
                <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-primary via-primary/90 to-primary/80 text-white flex-col justify-between p-12">
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-2xl font-bold">Gmail Automation</span>
                        </div>
                    ...
                    <div className="space-y-8">
                        <div>
                            <h2 className="text-4xl font-bold mb-4">Automate Your Email Workflow</h2>
                            <p className="text-lg text-primary-foreground/80">
                                Manage multiple Gmail accounts, run automations, and monitor everything in one powerful dashboard.
                            </p>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-primary-foreground/70">Handle unlimited Gmail accounts</p>
                                </div>
                            </div>
                            <div className="flex gap-3">
                                <div className="shrink-0 w-6 h-6 rounded-full bg-white/20 flex items-center justify-center">
                    ...
                    <p className="text-sm text-primary-foreground/60">© 2025 Gmail Automation Manager. All rights reserved.</p>
                </div>
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
                    <div className="w-full max-w-md space-y-8">
                        ...
                        <div className="lg:hidden flex items-center gap-3 mb-8">
                            ...
                            <span className="text-xl font-bold text-foreground">Gmail Automation</span>
                        </div>
