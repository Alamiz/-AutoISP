...
class LoginPageHandler(StateHandler):
    ...
    async def handle(self, page: Page) -> FlowResult:
        try:
            ...
            password_elements = await deep_find_elements(page, "input#password")
            password_field_visible = any(await el.is_visible() for el in password_elements)
            ...
            start_time = time.perf_counter()
            captcha_elements = await deep_find_elements(page, "div[data-testid='captcha']")
